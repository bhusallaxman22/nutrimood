...
// Gradients removed: keep empty stub if referenced
export const getGradient = (_variant: string): string[] => [];
...
export const getButtonStyle = (
  ...
  const variantStyles = {
    ...
    cosmic: {
      backgroundColor: colors.material.tertiary,
    ...
    volcano: {
      backgroundColor: colors.material.coral,
      borderColor: colors.material.coral,
      ...shadows.colored,
    },
    maximalist: {
